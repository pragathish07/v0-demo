    ...
    <section className="py-12 sm:py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-8 sm:top-16 left-6 sm:left-12 w-12 h-12 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-400/30 to-pink-400/30 rounded-full blur-xl"
        />
        <motion.div
          animate={{
            y: [0, 18, 0],
          ...
          className="absolute bottom-10 sm:bottom-20 right-10 sm:right-20 w-16 h-16 sm:w-28 sm:h-28 bg-gradient-to-br from-purple-300/20 to-blue-300/20 rounded-full blur-2xl"
        />
      </div>
      ...
      <div className="container mx-auto px-3 sm:px-4 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-pink-100 px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-4 sm:mb-6"
          >
            <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" />
            <span className="text-purple-700 font-medium text-sm sm:text-base">Book Your Appointment</span>
          </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex gap-3 sm:gap-4 p-4 sm:p-6 bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-purple-100 hover:shadow-lg transition-all duration-300"
                  >
          ...
          >
            <Card className="bg-white/90 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl border border-purple-100 text-center">
              <CardContent className="space-y-6 sm:space-y-8">
                ...
                >
                  <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-lg font-bold animate-pulse">
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4 py-4 sm:py-6">
                  {[
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.6, delay: index * 0.1 }}
                      viewport={{ once: true }}
                      className="text-center p-2 sm:p-4 bg-purple-50 rounded-lg sm:rounded-xl"
                    >
                      <div className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-purple-600 mb-1">{stat.number}</div>
                ...
                >
                  <Button
                    size="lg"
                    asChild
                    className="text-sm sm:text-lg lg:text-xl px-6 sm:px-8 lg:px-12 py-4 sm:py-5 lg:py-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white w-full transform hover:scale-105 transition-all duration-300 shadow-2xl border-0 rounded-xl sm:rounded-2xl font-bold"
                  >
                    <a
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-2 sm:-top-4 -right-2 sm:-right-4 w-12 h-12 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-400/40 to-pink-400/40 rounded-full opacity-20 blur-xl animate-pulse" />
            <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-300/30 to-blue-300/30 rounded-full opacity-15 blur-lg animate-bounce" />
          </motion.div>
        </div>
      </div>
    </section>
